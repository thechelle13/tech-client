        ...
        <main className="container--login">
            ...
            <section>
                <form className="form--login" onSubmit={handleLogin}>
                    <h1 className="text-4xl mt-7 mb-3">TechPower</h1>
                    <h2 className="text-xl mb-10">Please log in</h2>
            ...
            <div className="loginLinks">
                <section className="link--register">
                    <Link className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" to="/register">Not a Tech member yet?</Link>
                </section>
            </div>
        </main>
    )
